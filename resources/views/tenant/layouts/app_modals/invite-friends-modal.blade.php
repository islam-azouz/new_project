        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="btn btn-light-primary fw-bold w-100 mb-8">
                    <img alt="Logo" src="{{ global_asset('/') }}/assets/media/svg/brand-logos/google-icon.svg"
                    ...
                    <div class="mh-300px scroll-y me-n7 pe-7">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ global_asset('/') }}/assets/media/avatars/300-6.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ global_asset('/') }}/assets/media/avatars/300-1.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ global_asset('/') }}/assets/media/avatars/300-5.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic"
                                        src="{{ global_asset('/') }}/assets/media/avatars/300-25.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic"
                                        src="{{ global_asset('/') }}/assets/media/avatars/300-9.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic"
                                        src="{{ global_asset('/') }}/assets/media/avatars/300-23.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic"
                                        src="{{ global_asset('/') }}/assets/media/avatars/300-12.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic"
                                        src="{{ global_asset('/') }}/assets/media/avatars/300-13.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic"
                                        src="{{ global_asset('/') }}/assets/media/avatars/300-21.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-5">
