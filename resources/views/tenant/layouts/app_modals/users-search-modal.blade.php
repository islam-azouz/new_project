                    ...
                    <div class="py-5">
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                ...
                                <a href="#"
                                    ...
                                    <div class="symbol symbol-35px symbol-circle me-5">
                                        <img alt="Pic"
                                            src="{{ global_asset('/') }}/assets/media/avatars/300-6.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                ...
                                <a href="#"
                                    ...
                                    <div class="symbol symbol-35px symbol-circle me-5">
                                        <img alt="Pic"
                                            src="{{ global_asset('/') }}/assets/media/avatars/300-1.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="fw-semibold">
                                ...
                                <a href="#"
                                    ...
                                    <div class="symbol symbol-35px symbol-circle me-5">
                                        <img alt="Pic"
                                            src="{{ global_asset('/') }}/assets/media/avatars/300-5.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="fw-semibold">
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="{{ global_asset('/') }}/assets/media/illustrations/sketchy-1/1.png"
