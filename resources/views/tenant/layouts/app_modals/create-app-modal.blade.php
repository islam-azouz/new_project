                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="{{ global_asset('/') }}/assets/media/svg/card-logos/visa.svg"
                                                    alt="" class="h-25px" />
                                                <img src="{{ global_asset('/') }}/assets/media/svg/card-logos/mastercard.svg"
                                                    alt="" class="h-25px" />
                                                <img src="{{ global_asset('/') }}/assets/media/svg/card-logos/american-express.svg"
                                                    alt="" class="h-25px" />
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="{{ global_asset('/') }}/assets/media/illustrations/sketchy-1/9.png"
