                    ...
                    <div class="tab-content py-4 py-lg-8 px-lg-7">
                        ...
                        <div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages">
                            ...
                            <div class="row">
                                ...
                                <!--begin:Col-->
                                <div class="col-lg-4">
                                    <img src="{{ global_asset('/')}}/assets/media/stock/600x600/img-82.jpg" class="rounded mw-100" alt="" />
                                </div>
                                <!--end:Col-->
                            </div>
                            <!--end:Row-->
                        ...
                        <div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account">
                            ...
                            <div class="row">
                                ...
                                <!--begin:Col-->
                                <div class="col-lg-7">
                                    <img src="{{ global_asset('/')}}/assets/media/stock/900x600/46.jpg" class="rounded mw-100" alt="" />
                                </div>
                                <!--end:Col-->
                            </div>
                            <!--end:Row-->
                        ...
                        <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 pe-lg-5">
                                    <img src="{{ global_asset('/')}}/assets/media/stock/600x600/img-84.jpg" class="rounded mw-100" alt="" />
                                </div>
                                <!--end:Col-->
                            </div>
                            <!--end:Row-->
                        ...
                        <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
                            ...
                            <div class="row">
                                ...
                                <!--begin:Col-->
                                <div class="col-lg-8">
                                    <img src="{{ global_asset('/')}}/assets/media/stock/900x600/44.jpg" class="rounded mw-100" alt="" />
                                </div>
                                <!--end:Col-->
                            </div>
                            <!--end:Row-->
                ...
                <div class="menu-active-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center">
                            <img src="{{ global_asset('/')}}/assets/media/stock/900x600/45.jpg" class="rounded mw-100" alt="" />
                        </div>
                        <!--end:Col-->
                    </div>
                    <!--end:Row-->
