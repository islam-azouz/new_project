<div class="app-navbar-item ms-1 ms-md-4">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
        <!--begin::Heading-->
        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ global_asset('/')}}/assets/media/misc/menu-header-bg.jpg')">
            <!--begin::Title-->
            ...
            <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                ...
                <div class="d-flex flex-column px-9">
                    ...
                    <div class="text-center px-4">
                        <img class="mw-100 mh-200px" alt="image" src="{{ global_asset('/')}}/assets/media/illustrations/sketchy-1/1.png" />
                    </div>
                    <!--end::Illustration-->
                </div>
                <!--end::Wrapper-->
