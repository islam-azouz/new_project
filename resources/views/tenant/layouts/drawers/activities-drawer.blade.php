                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        ...
                                        <img alt="" class="w-30px me-3"
                                            src="{{ global_asset('/') }}/assets/media/svg/files/pdf.svg" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        ...
                                        <img alt="apps/projects/project.html" class="w-30px me-3"
                                            src="{{ global_asset('/') }}/assets/media/svg/files/doc.svg" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-semibold">
                                            <!--begin::Desc-->
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        <!--begin::Icon-->
                                        <img alt="apps/projects/project.html" class="w-30px me-3"
                                            src="{{ global_asset('/') }}/assets/media/svg/files/css.svg" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-semibold">
                                            <!--begin::Desc-->
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ global_asset('/') }}/assets/media/stock/600x400/img-29.jpg" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ global_asset('/') }}/assets/media/stock/600x400/img-31.jpg" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                    ...
                                    <div class="overlay">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ global_asset('/') }}/assets/media/stock/600x400/img-40.jpg" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
